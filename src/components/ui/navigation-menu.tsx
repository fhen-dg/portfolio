...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Link
    ref={ref}
    className={cn(
      "inline-flex h-[36px] items-center justify-center gap-2 whitespace-nowrap rounded-md px-[14px] py-[6px] body3 ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 text-neutral-black lg:hover:bg-neutral-100 lg:hover:text-primary-base",
      className
    )}
    {...props}
  />
