    ...
    <section className="flex justify-center w-full">
      <div className="flex flex-col gap-[40px] items-start max-w-[1024px] h-[calc(100vh-160px)] w-full text-center">
        ...
        <div className="flex flex-1 flex-col gap-[28px] items-center justify-center w-full text-neutral-800">
          <p className="body1 w-full">
            {t.hero.introPrefix}
            <span className="font-medium text-primary-base">Fhen</span>
          </p>
          <p className="header1 w-full">
            {t.hero.heading}
          </p>
          <p className="supporting2 w-full">
            {t.hero.tagline}
          </p>
        </div>

        {/* Info captions row */}
        <div className="flex flex-wrap gap-[20px] items-start justify-center body1 text-neutral-600 w-full shrink-0">
          <p>{t.hero.role}</p>
          <p>•</p>
          <p>{t.hero.location}</p>
        </div>
