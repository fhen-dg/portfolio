...
export function CaseSolutionSection({ body }: CaseSolutionSectionProps) {
  return (
    <section className="flex justify-center w-full">
      <div className="flex flex-col gap-[40px] lg:gap-[52px] max-w-[960px] w-full items-end">
        <h2 className="title1 lg:header1 text-neutral-800 w-full text-right">
          The Solution
        </h2>
        <p className="supporting1 text-neutral-600 text-right">
          {body.map((segment, i) =>
            segment.emphasis ? (
